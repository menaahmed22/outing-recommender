...
if search_type is not None:
    ...
    st.write("Waiting for search_type...")    
...
if distance is not None:
    ...
    st.write("Waiting for distance...")  


count_of_results = st.number_input("Insert a number of max needed places", value=None, placeholder="Type a number...")

if count_of_results is not None:
       count_of_results = count_of_results
    st.write("The current number is ", count_of_results)
else:
    st.write("Waiting for count_of_results...")
